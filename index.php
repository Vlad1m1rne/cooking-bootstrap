    ...
    <div class="container ">
      ...
      <div class="row row-header">
        <div class="col text-center">
          <form method="POST"><button type="submit" name="show" value="all" class="btn btn-outline-success btn-lg">Все рецепты</button></form>
        </div>
        <div class="col text-center">
          <form method="POST"><button type="submit" name="show" value="first" class="btn btn-outline-success btn-lg">Первые блюда</button></form>
        </div>
        <div class="col text-center">
          <form method="POST"><button type="submit" name="show" value="second" class="btn btn-outline-success btn-lg">Вторые блюда</button></form>
        </div>
        <div class="col text-center">
          <form method="POST"><button type="submit" name="show" value="salat" class="btn btn-outline-success btn-lg">Салаты</button></form>
        </div>
        <div class="col text-center">
          <form method="POST"><button type="submit" name="show" value="cake" class="btn btn-outline-success btn-lg">Выпечка</button></form>
        </div>
        <div class="col text-center">
